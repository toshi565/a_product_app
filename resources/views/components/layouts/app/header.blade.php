...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container
        class="border-b bg-brand-navy text-white border-brand-gold/30 dark:bg-brand-navy dark:text-white">
    ...
    <!-- Mobile Menu -->
    <flux:sidebar stashable sticky class="lg:hidden border-e border-brand-gold/30 bg-brand-navy text-white">
